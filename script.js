(function() {
  ...
  function initContactForm() {
    ...
    form.addEventListener('input', function(e) {
      ...
      if (!field || !validationRules[field.name]) return;
      validateField(field);
    });
    ...
    form.addEventListener('submit', function(e) {
      ...
      if (isValid) {
        ...
        setTimeout(function() {
          ...
          successMessage.style.cssText = 'background: #d4edda; color: #155724; padding: 1rem; border-radius: 4px; margin-top: 1rem; text-align: center;';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'e82c8337-13b2-4f70-84be-f9e499fd06c8',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'e82c8337-13b2-4f70-84be-f9e499fd06c8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e82c8337-13b2-4f70-84be-f9e499fd06c8';
